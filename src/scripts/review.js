...
var reviews = [
  {
    heading:
      "One of the most emotional endings for the album, I couldn't hold myself at the end",
    album: "4",
    review: `
  ...
  {
    heading:
      "The collapse of the trumpoline feels line an end of an era honestly.",
    album: "1",
    review: `
  ...
  {
    heading:
      "Winter night, it's the 6th October If I had a one wish for my birthday, it would be some more ten-ten yola.",
    album: "3",
    review: `
